...
router.get('/donor', roleMiddleware.isDonor, dashboardController.getDonorDashboard);
router.get('/volunteer', roleMiddleware.isVolunteer, dashboardController.getVolunteerDashboard);
router.get('/admin', roleMiddleware.isAdmin, dashboardController.getAdminDashboard);
...
router.get(
    ...
    [
        query('period').optional().isIn(['7days', '30days', '90days', '1year', 'custom']).withMessage('Valid period is required'),
...
router.get('/summary/donor', roleMiddleware.isDonor, dashboardController.getDonorSummary);
router.get('/summary/volunteer', roleMiddleware.isVolunteer, dashboardController.getVolunteerSummary);
router.get('/summary/admin', roleMiddleware.isAdmin, dashboardController.getAdminSummary);
...
router.get('/tasks', roleMiddleware.isVolunteer, dashboardController.getDashboardTasks);
router.post('/tasks', roleMiddleware.isVolunteer, dashboardController.createDashboardTask);
router.put('/tasks/:id', roleMiddleware.isVolunteer, dashboardController.updateDashboardTask);
router.delete('/tasks/:id', roleMiddleware.isVolunteer, dashboardController.deleteDashboardTask);
...
router.get(
    ...
    [
        ...
        query('type').optional().isIn(['users', 'donations', 'funding', 'all']).withMessage('Valid search type is required'),
...
router.post(
    '/export',
    [
        body('type').isIn(['summary', 'activity', 'stats']).withMessage('Valid export type is required'),
        body('format').isIn(['pdf', 'csv', 'excel']).withMessage('Valid export format is required'),
...
router.post('/announcements', roleMiddleware.isAdmin, dashboardController.createAnnouncement);
router.put('/announcements/:id', roleMiddleware.isAdmin, dashboardController.updateAnnouncement);
router.delete('/announcements/:id', roleMiddleware.isAdmin, dashboardController.deleteAnnouncement);
...
router.get('/backup/list', roleMiddleware.isAdmin, dashboardController.getBackupList);
router.post('/backup/restore', roleMiddleware.isAdmin, dashboardController.restoreBackup);

// Dashboard system status
router.get('/system-status', roleMiddleware.isAdmin, dashboardController.getSystemStatus);
